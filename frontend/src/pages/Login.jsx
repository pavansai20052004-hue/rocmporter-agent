...
const HIGHLIGHTS = [
  ...
  'AI-generated, verified ROCm patches',
  'GitHub-ready pull-request reviews',
]
  ...
  return (
    <div className="auth-split">
      ...
      <aside className="auth-hero" aria-hidden="true">
        ...
        <div className="auth-hero-scene">
          <div className="chip3d chip3d-lg">
                ...
                <div className="chip-die">
                  <div className="chip-grid">
                    {Array.from({ length: 16 }, (_, i) => (
                      <span key={i} className="chip-cell" style={{ animationDelay: `${(i % 5) * 0.3}s` }}></span>
                    ))}
                  </div>
                </div>
        ...
        <div className="auth-hero-copy">
          <h2>Migrate CUDA to AMD ROCm with confidence.</h2>
        ...
        <div className="auth-card auth-card-v2">
          ...
          {!isConfigured ? (
            <div className="warning-banner low auth-config-note">
              ...
              <span>
                Add your Supabase keys (VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY) to enable sign-in. The
                scanner still works without an account.
              </span>
            </div>
          ) : null}
